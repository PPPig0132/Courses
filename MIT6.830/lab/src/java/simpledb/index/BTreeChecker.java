...
public class BTreeChecker {
    ...
    static class SubtreeSummary {
        ...
        static SubtreeSummary checkAndMerge(SubtreeSummary accleft, SubtreeSummary right) {
            ...
            // if(right.ptrRight==null){
            //     System.err.println("Assertion failed:right = " + right.rightmostId);
            // }
            // if(accleft.ptrRight==null){
            //     System.err.println("Assertion failed:accleft = " + right.rightmostId);
            // }
