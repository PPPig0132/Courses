...
public class SeqScan implements OpIterator {
    ...
    private int tableid; // The table to scan
    private String tableAlias; // The alias of this table (needed by the parser)
    private DbFileIterator iterator; // The iterator for the table scan
    private boolean isOpen = false; // Flag to check if the scan is open
